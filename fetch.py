#!/usr/bin/env python3
"""
Recuperation des codes promo Micromania depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/micromania.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/micromania.fr"
STORE_NAME = "Micromania"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Micromania depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-micromania)"
    }
    try:
